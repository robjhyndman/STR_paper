...
> As suggested, we have added some simulation experiments to demonstrate our proposed method. These appear in Section ?? and in the appendix.
...
> We have now included some comparison methods in the simulations and in the appendix.
...
> Yes, that is correct. We have added a paragraph after the introduction of our model describing some special cases.
