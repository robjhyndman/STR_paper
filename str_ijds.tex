...
\hypersetup{
            pdftitle={STR: Seasonal-Trend decomposition using Regression},
            pdfkeywords={time series decomposition, seasonal data, Tikhonov regularisation, ridge regression, LASSO, STL, TBATS, X-12-ARIMA, X-13-ARIMA-SEATS, BSM},
            pdfborder={0 0 0},
            breaklinks=true}
...
\addresses{\textbf{Alexander Dokumentov}\newline
Let's Forecast\newline Australia
\\[1cm]
\textbf{Rob J Hyndman}\newline
Monash University\newline Australia
...
\makeatletter
 \lfoot{\sf Dokumentov, Hyndman: \@date}
\makeatother
...
\end{abstract}
\begin{keywords}
time series decomposition, seasonal data, Tikhonov regularisation, ridge regression, LASSO, STL, TBATS, X-12-ARIMA, X-13-ARIMA-SEATS, BSM
\end{keywords}
...
\begin{figure}
\centering
\includegraphics{str_ijds_files/figure-latex/examples-1.pdf}
...
\begin{figure}
\centering
\includegraphics{str_ijds_files/figure-latex/supermarket-1.pdf}
...
\begin{figure}
\centering
\includegraphics{str_ijds_files/figure-latex/vic-1.pdf}
...
\begin{figure}
\centering
\includegraphics{str_ijds_files/figure-latex/MelTemp-1.pdf}
...
Similarly, seasonal functional components can be obtained, using Fourier terms for example \autocite[reminiscent of][]{delivera2011forecasting}. This approach leads, with no additional effort, to handling seasonality with a fractional or varying period.
